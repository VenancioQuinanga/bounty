    ...
    <aside>
        <nav id="dropdown">
            <ul>
                ...
                <li class="myHidden"><a href="./meus-produtos">Meus produtos</a></li>
                <li class="myHidden"><a href="./adquiridos">Adquiridos</a></li>
                <li class="myHidden"><a href="./produtores">Produtores</a></li>
                <li class="myHidden"><a href="./afiliados">Afiliados</a></li>
                <li class="myHidden"><a href="./depositos">Depositos</a></li>
                <li class="myHidden"><a href="./carteira">Carteira</a></li>
                <li class="myHidden"><a href="./saques">Saques</a></li>
                <li class="myHidden"><a href="./cursos">Cursos</a></li>
                <li class="myHidden"><a href="./livros">Livros</a></li>                
            </ul>
        </nav>
    </aside>
</header>
