            ...
            if ($a < 1) {
                ...
                echo "
                    <div class='carousel-item'>                
                        <img src='$url/public/img/categorias/$foto' class='d-block w-100 ht-middle'>
                        <div class='carousel-caption mb-5 d-md-block'>
                            <h5><strong class='text-dark'>$categoria</strong></h5>
                            <div class='d-block'>
                                <a href='./ver-categoria?id=$id'>
...
<div class="container-xxl center">
    <h1 class="text-primary pt-5 mt-5 ms-5">Cursos recentes</h1>
    <?php
        if (!empty($cursos)) {
            ...
            echo "<p class='center mt-3'>Não há cursos recentes</p>";
        }
...
<div class="container-xxl center">
    ...
    <?php
        if (!empty($cursos)) {
            ...
            echo "<p class='center mt-3'>Não há cursos cadastrados</p>";
        }
