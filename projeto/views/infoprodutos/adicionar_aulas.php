    ...
    <div class="row">
        <div class="col-md-7 mt-5 mb-5" style="margin-left:auto;margin-right:auto;">
            ...
            <div class="card p-4 shadow">
                <div class="card-body">
                    <form action="./adicionar-aula?id_curso=<?=$_GET['id_curso']?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="number" name="licao" class="form-control mt-2" placeholder="Lição n°">        
                        <label class="mt-2 text-dark font-weight-bold">Sumário</label>
                        <input type="text" name="sumario" class="form-control mt-2" placeholder="Sumário">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="submit" name="subir_video_aula" class="btn btn-primary form-control me-auto text-light mt-2 font-weight-bold" value="Subir aula">
                        </div>
                    </form>
                </div>
            </div>
